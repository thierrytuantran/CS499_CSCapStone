...
public class DataDisplayActivity extends AppCompatActivity {
    ...
    private void loadEvents() {
        eventList.clear();
        Cursor cursor = databaseHelper.getAllEvents(userId); // Fetch events for the user
        ...
        eventAdapter.sortEvents((event1, event2) -> event1.getName().compareToIgnoreCase(event2.getName()));
    ...
    private void showAddEventDialog() {
        ...
        // Positive button to add the event
        builder.setPositiveButton(android.R.string.ok, (dialog, which) -> {
            ...
            if (!eventName.isEmpty()) {
                ...
                // Sort events alphabetically after adding
                eventAdapter.sortEvents(Event::compareTo);
